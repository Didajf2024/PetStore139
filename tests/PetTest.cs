...
public class PetTest
{
    ...
    {
        // Configura
        int petId = 3486830;            // campo de pesquisa
        String petName = "bob";      // resultado esperado
    ...
    public void GetUserLoginTest(){
        ...
        // https://petstore.swagger.io/v2/user/login?username=jucabala&password=teste
        // Executa
        var response = client.Execute(request);
